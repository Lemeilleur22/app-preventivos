...
if st.session_state.pantalla == "landing":
    ...
    <div class="hero">
        ...
        <div class="content">
            ...
            <a href="?page=login" class="btn">Acceder</a>
...
if st.session_state.pantalla == "login":
    colum1, colum2, colum3 = st.columns([2, 2, 2])
    ...
    with column2:
        ...
        if st.button("Ingresar Admin"):
            try:
                ...
                if res.user and res.user.email == "ethanmijail22@gmail.com":
                    st.session_state.user = res.user

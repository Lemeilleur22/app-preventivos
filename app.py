    ...
    with tab0:
        ...
        if df_dash.empty:
            ...
            with sub1:
                ...
                df_diario["realizada"] = df_diario["estatus"].eq("REALIZADO")
                ...
                fig_cumplimiento_diario = px.bar(
                    ...
                    y="cumplimiento",
                    text="cumplimiento",
                    hover_data=["programadas", "realizadas", "pendientes"],
                    custom_data=["dia_str"],
                ...
                if puntos:
                    ...
                    df_detalle_dia["dia_str"] = pd.to_datetime(
                        df_detalle_dia["dia"]
                    ).dt.strftime("%Y-%m-%d")

                    df_detalle_dia = df_detalle_dia[
                        df_detalle_dia["dia_str"] == dia_seleccionado
                    ].copy()
                    ...
                    df_detalle_dia.loc[
                        ...
                        & (pd.to_datetime(df_detalle_dia["fecha_visible_dt"]).dt.date < hoy),
                        "seguimiento"
                    ] = "ATRASADA"

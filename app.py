...
def enviar_reporte_semanal_supervisores():
    ...
    for tecnico, grupo in df.groupby("tecnico"):
        ...
        pendientes_tecnico = len(
            grupo[grupo["estatus"].isin(["PENDIENTE", "EN PROCESO"])])
        realizados_tecnico = len(grupo[grupo["estatus"] == "REALIZADO"])
        ...
        <div class="tecnico-card">
            ...
            <p class="meta">
                ...
                <b>Realizados:</b> {realizados_tecnico} |
                <b>Pendientes:</b> {pendientes_tecnico}
            </p>

        ...
        if df_dash.empty:
            ...
            with sub1:
                ...
                fig_cumplimiento_diario = px.bar(
                    ...
                    barmode="group",
                    text="cumplimiento",
                    hover_data=["programadas", "realizadas",
                                "realizadas_destiempo", "pendientes"],
                    custom_data=["dia_str"],
                ...
                if puntos:
                    ...
                    df_detalle_dia.loc[
                        ...
                        & (pd.to_datetime(df_detalle_dia["fecha_visible_dt"]).dt.date < date.today()),
                        "seguimiento"
                    ] = "ATRASADA"

                    total_dia = len(df_detalle_dia)
                    realizadas_dia = len(
                        df_detalle_dia[df_detalle_dia["estatus"] == "REALIZADO"])
                    pendientes_dia = total_dia - realizadas_dia

                    c1, c2, c3 = st.columns(3)

                    c1.metric("Programadas", total_dia)
                    c2.metric("Realizadas", realizadas_dia)
                    c3.metric("Pendientes / atrasadas", pendientes_dia)
                    ...
                    st.dataframe(
                        df_detalle_dia[columnas_detalle],
                        use_container_width=True,
                        hide_index=True
                    )
                else:

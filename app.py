    ...
    with tab0:
        ...
        if df_dash.empty:
            ...
            with sub1:
                ...
                fig_estado.update_layout(template="plotly_white", height=360)
                ...
                col_estado, col_tabla, col_area = st.columns([1.45, 1, 1.45])
                ...
                with col_area:
                    st.plotly_chart(fig_area_resumen, use_container_width=True)

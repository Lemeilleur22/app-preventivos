...
if modo == "General":
    ...
    if not df_prev.empty:
        ...
        # ---------------
            ...
            db_texto = anotacion_actual or ""

            if st.session_state.get(key_anot) is None:
                st.session_state[key_anot] = db_texto
            ...
            if evidencia_inicio and isinstance(evidencia_inicio, str) and evidencia_inicio.startswith("http"):
                try:
                    ...
                    st.warning("La evidencia inicial esta corrupta o es invalida")
            ...
            if evidencia_fin and isinstance(evidencia_fin, str) and evidencia_fin.startswith("http"):
                try:
                    ...
                    st.warning("La evidencia final esta corrupta o es invalida")
                    evidencia_fin = None

...
def mostrar_detalle_jobplan(ot_data):
    ...
    if jpnum and not pd.isna(jpnum):
        ...
        if tareas:
            ...
            columnas_posibles = [
                "taskid", "jptask", "descripcion", "description",
                "sequence", "laborhrs", "craft", "pluscjptask"
            ]
            ...
            if columnas_mostrar:
                st.dataframe(
                    df_tareas[columnas_mostrar],
                    width="stretch",
                    hide_index=True
                )
            else:
                st.dataframe(df_tareas, width="stretch", hide_index=True)
        else:
            st.info("Esta OT no tiene tareas de Job Plan cargadas.")
    else:
